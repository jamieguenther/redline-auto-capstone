...
request.onload = function() {
  ...
  if (request.status >= 200 && request.status < 400) {
    ...
    for(var i = 0, l = vehicles.length; i < l; i++){
        ...
        if (("JUL" == vehicle.VHCL_SLDM || "AUG" == vehicle.VHCL_SLDM || "SEP" == vehicle.VHCL_SLDM ||
           "Jul" == vehicle.VHCL_SLDM || "Aug" == vehicle.VHCL_SLDM || "Sep" == vehicle.VHCL_SLDM) && year == vehicle.VHCL_SLDY)
        {
          makeList(vehicle);
        }
    }   
