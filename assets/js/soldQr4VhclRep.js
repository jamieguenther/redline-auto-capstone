...
request.onload = function() {
  ...
  if (request.status >= 200 && request.status < 400) {
    ...
    for(var i = 0, l = vehicles.length; i < l; i++){
        ...
        if (("OCT" == vehicle.VHCL_SLDM || "NOV" == vehicle.VHCL_SLDM || "DEC" == vehicle.VHCL_SLDM ||
           "Oct" == vehicle.VHCL_SLDM || "Nov" == vehicle.VHCL_SLDM || "Dec" == vehicle.VHCL_SLDM) && year == vehicle.VHCL_SLDY)
        {
          makeList(vehicle);
        }
    }   
